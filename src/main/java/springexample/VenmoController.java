...
public class VenmoController {
    ...
    @RequestMapping(value = "/venmo", method = RequestMethod.GET)
    public String root(Model model) {
        return "redirect:venmo/checkouts";
    }

    @RequestMapping(value = "/venmo/checkouts", method = RequestMethod.GET)
    public String checkout(Model model) {
        String clientToken = gateway.clientToken().generate();
        model.addAttribute("clientToken", clientToken);

        return "venmo/checkouts/new";
    }

    @RequestMapping(value = "/venmo/checkouts", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/venmo/checkouts/{transactionId}")
